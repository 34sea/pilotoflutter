...
// import 'package:yard_flow/view/component/terminal_flow_app_bar.dart';
...
//   login() async {
//     bool status = await widget.viewModel.login();

//     setState(() {
//       loginStatus = Future.value(status); 
//     });
...
// scaffoldBackgroundColor: Colors.white, //adicionei